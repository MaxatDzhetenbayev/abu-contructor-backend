...
export class NavigationsService {
  ...
  async create(createNavigationDto: CreateNavigationDto) {
    try {
      ...
      if (!navigation) throw new InternalServerErrorException('Navigation could not be created');
  ...
  async findAll() {
    try {
      ...
      if (!navigations) throw new InternalServerErrorException('Navigations could not be finded');
  ...
  async findBySlug(slug: string) {
    ...
    try {
      ...
      if (!findedPage) throw new InternalServerErrorException('Navigation could not be finded');
  ...
  async update(id: number, updateNavigationDto: UpdateNavigationDto) {
    ...
    try {
      ...
      if (!navigation) throw new InternalServerErrorException('Navigation could not be finded');
